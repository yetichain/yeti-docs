    ...
    >
        <div className="container">
          <div className="footer_logo-row">
            <a href="https://yetichain.com" aria-current="page" className="nav_logo-link is-footer w-nav-brand w--current">
              <img src="/img/yeti.svg" loading="lazy" width="113" height="36" alt=""/>
            </a>

            <div className="footer_sm-link-wrapper">
              <a href="https://twitter.com/yetichain" target="_blank" className="w-inline-block">
              ...
              <a href="https://t.me/yetichain" target="_blank" className="w-inline-block">
                <div className="icon-1x1-medium is-footer-icon w-embed">
                  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://discord.gg/yetichain" target="_blank" className="w-inline-block">
                <div className="icon-1x1-medium is-footer-icon w-embed">
                  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://www.reddit.com/r/yetichain/" target="_blank" className="w-inline-block">
                <div className="icon-1x1-medium is-footer-icon w-embed">
                  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://github.com/yetichain/" target="_blank" className="w-inline-block">
                <div className="icon-1x1-medium is-footer-icon w-embed">
                  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://www.facebook.com/yetichain/" target="_blank" className="w-inline-block">
                <div className="icon-1x1-medium is-footer-icon w-embed">
                  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://www.linkedin.com/company/yetichain/" target="_blank" className="w-inline-block">
                <div className="icon-1x1-medium is-footer-icon w-embed">
              ...
              <a href="https://www.youtube.com/@yetichain" target="_blank" className="w-inline-block">
                <div className="icon-1x1-medium is-footer-icon w-embed">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
