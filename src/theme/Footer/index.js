        ...
        <div className="container">
          <div className="footer_logo-row">
            ...
            <div className="footer_sm-link-wrapper">
              ...
              <a href="https://t.me/antofylabsl" target="_blank" className="w-inline-block">
                <div className="icon-1x1-medium is-footer-icon w-embed">
                  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://discord.gg/antofy" target="_blank" className="w-inline-block">
                <div className="icon-1x1-medium is-footer-icon w-embed">
                  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://www.reddit.com/r/0xantofy/" target="_blank" className="w-inline-block">
                <div className="icon-1x1-medium is-footer-icon w-embed">
                  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
